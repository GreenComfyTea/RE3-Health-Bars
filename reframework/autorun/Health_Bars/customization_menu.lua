...
function this.draw()
	...
	if imgui.tree_node(cached_language.settings) then
		...
		changed, cached_config.settings.render_when_game_is_paused = imgui.checkbox(cached_language.render_when_game_is_paused,
		...
		changed, cached_config.settings.hide_if_enemy_is_not_in_sight = imgui.checkbox(cached_language.hide_if_enemy_is_not_in_sight,
			cached_config.settings.hide_if_enemy_is_not_in_sight);
		config_changed = config_changed or changed;
