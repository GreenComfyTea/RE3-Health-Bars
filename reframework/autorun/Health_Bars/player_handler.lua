...
local player_manager_type_def = sdk.find_type_definition("offline.PlayerManager");
...
local equipment_manager_type_def = sdk.find_type_definition("offline.EquipmentManager");
